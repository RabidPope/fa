...
Changelog = {
    ...
    Description = {
        ...
        "## Balance",
        "",
        "{% unit URL0303 %} Loyalist: T3 Siege Assault Bot {% endunit %} Reduce stun duration of Loyalist's Disintegrator Pulse Laser since it was",
        "extremely powerful against T2 units, Ilshavohs in particular (#7121).",
        "",
        "- Disintegrator Pulse Laser:",
        "  - Stun Duration against T1/T2 mobile units: 1.5s per shot (2.3s per volley) (70% stun uptime) -> 0.4s per shot (1.2s per volley) (36% stun",
        "    uptime)",
        "",
        "{% unit XEB2402 %} Novax Center: Experimental Satellite System {% endunit %} Reduce Novax's ability to kill many shields, T2 fabs, and",
        "engineers in a single volley, and rebalance its costs to make it more vulnerable to artillery fire, especially when built in large numbers",
        "(#7123).",
        "",
        ...
        "",
        "The build cost is reduced by the cost of power generators (with storage adjacency) required to power the satellite's firing cost. The energy",
        "cost is increased to guide players towards building the power required for firing before building the Novax.",
        "",
        "Remove Omni from the Novax as it unnecessarily counters cloak which is already more than sufficiently countered by T3 Omni radars. Since",
        "Omni can detect underwater units, sonar is added to partially keep that interaction.",
        "",
        "- Defense Satellite:",
        "",
        "  - Omni radius: 60 -> 0",
        ...
        "  targeted adjustments for weaker upgrades (engineering upgrades, UEF bubble shield, Seraphim Overcharge) (#7141, #7164).",
        "",
        ...
        "help with a faction's early issues, while Rambos play a role in the late game by being efficient but high infrastructure cost combat units,",
        ...
        "",
        "  Due to the SACU cost reduction making SACUs upgraded with only this gun upgrade overpowered, mass costs from EMP, Nano, and Cloaking are",
        "  moved to this upgrade.",
        "",
        "  - Mass cost: 800 -> 1400",
        ...
        "  buildpower of Seraphim SACU spam compared to other factions' RAS SACUs. Since players aren't using this, the RAS upgrade is replacing the",
        "  SACU's increased base production and base cost.",
        "",
        ...
        "",
        "  The Rambo preset is changed from Nano + Shield + Overcharge to Nano + Shield + Sensors/Gun Range. It can act as a lategame HP tank that",
        "  doesn't rely on energy for DPS like the Advanced Combatant preset or regen for survivability like the Nano Combatant preset.",
        "",
        ...
        "  - Energy maintenance cost: 300 -> 210",
        "",
        "{% unit XRL0302 %} Fire Beetle: T2 Mobile Bomb {% endunit %} Rebalance Fire Beetle with removed cloak to make it interactable outside of",
        "later T3 stage or in ACU fights (#7143).",
        "",
        ...
        "- Speed: 5 -> 3.8",
        "",
        "{% unit UAL0401 %} Galactic Colossus: Experimental Assault Bot {% endunit %} Rebalance Galactic Colossus's tractor claws so that the GC is",
        "weaker against T3 units by itself or when skirmishing but stronger with an army (#7146).",
        "",
        "- Tractor Claws (x2)",
        "  - DPS: 729 -> 240",
        "  - Range: 41 -> 30",
        ...
        "",
        "{% unit URL0401 %} Scathis: Experimental Mobile Rapid-Fire Artillery {% endunit %} Increase Scathis accuracy and survivability so it can",
        "better compete against other enders (#7147).",
        "",
        "- Health: 9000 -> 17000",
        "- Regen: 0 -> 134",
        ...
        "## Bug fixes",
        "",
        "- Fix the `ModWeapons` blueprint field adding weapons after dummy weapons, causing the unit weapon to incorrectly get the dummy weapon's",
        "  blueprint for the new weapon (#6882).",
        "",
        ...
        "  launch option (#7149).",
        "",
        "- Add a delay before ACUs explode when their player disconnects. This should fix replays cutting off at the first disconnected player",
        "  (#7153).",
        "",
        "- Fix mods that allow building units on water causing those units to not be buildable on land due to how the expected default of a missing",
        "  `BuildOnLayerCaps` table interacts with blueprint merge (#7159).",
        "",
        ...
        "",
        "- Fix salem wiggling and locking up when issued lots of move orders. This is done by changing the 5x5 floating/hover footprint spec to 4x4,",
        "  which only affects Salem in FAF but may affect large floating/hover units in mods by making them occupy slightly less space. (#7200)",
        "",
        "## Graphics",
        "",
        ...
        "## Other changes",
        "",
        "- Give a warning when non-dummy weapons are assigned dummy weapon blueprints because they are positioned after a dummy weapon blueprint in",
        "  the `Weapon` table of the unit blueprint (#6882).",
        "",
        ...
        "",
        "- Update the FA Lua plugin used alongside our vscode intellisense extension to exclude diagnostics coming from the base file when writing a",
        "  mod's hook file (#7176).",
        "",
